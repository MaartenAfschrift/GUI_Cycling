function [CasF] = GetCasEq_MuscleDynamics_VU(parms)
% CasadiFunc_CyclingModel Creates all casadi functions for cycling model
...
%% force-length tendon and muscle
...
[vcerel] = Muscle_F_V_VU(fcerel,q,lcerel,parms);
